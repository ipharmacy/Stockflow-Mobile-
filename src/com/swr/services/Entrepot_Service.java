...
import com.swr.utils.DataSource;
...
public boolean ModifierEntrepot(Entrepot abonnment,int id) {
    ...
    public ArrayList<Entrepot> getAllentrepots() {
        ...
        String url = Statics.BASE_URL + "entrepotmobile/AllEntrepot?id="+id;
        request.setUrl(url);
    ...
    public ArrayList<Entrepot> parsentrepots(String jsonText) throws IOException {
     ...
     public boolean addEntrepot(Entrepot v) {
        int id=SessionUser.loggedUser.getId();
        String url = Statics.BASE_URL + "entrepotmobile/AddEntrepot?nom=" + v.getNom()+ "&adresse=" + v.getAdresse()+ "&etat=" + v.getEtat()+ "&image=" + v.getImage()+ "&longitude=" + v.getLongitude()+ "&largitude=" + v.getLargitude()+ "&idU="+id;
     ...
     public boolean removeEntrepot(int id) {
        ...
        String url = Statics.BASE_URL + "entrepotmobile/statEntrepot?idU="+14;
