 ...
 * @author chihe
 */
public class EmployesSortedByStatus extends BaseForm{
    Form current;
    Resources theme= UIManager.initFirstTheme("/theme");;   

    public EmployesSortedByStatus(Form previous)
    {
        current=this;
        for(Employe e:com.swr.services.ServicesEmploye.getInstance().getAllEmployesSortedByStatus())
        { 
